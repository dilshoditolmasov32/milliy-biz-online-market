...
function createCssVarsProvider(options) {
  ...
  function CssVarsProvider2(props) {
    ...
    const element = (0, import_jsx_runtime13.jsxs)(React34.Fragment, {
      children: [shouldGenerateStyleSheet && (0, import_jsx_runtime13.jsxs)(React34.Fragment, {
...
var RowListContext = React40.createContext(false);
if (true) {
...
function useRootElementName(parameters) {
  ...
  const [rootElementName, setRootElementName] = React42.useState(rootElementNameProp.toUpperCase());
  if (true) {
    React42.useEffect(() => {
  ...
  const updateRootElementName = React42.useCallback((instance) => {
...
var VariantColorContext = React49.createContext(void 0);
if (true) {
...
function useVariantColor(instanceVariant, instanceColor, alwaysInheritColor = false) {
  const value = React49.useContext(VariantColorContext);
...
@mui/private-theming/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-V5X74INJ.js.map
